...
Поддерживаются все популяюрные кодировки текста (автоопределение кодировки)
* .txt -> .pdf
* .csv -> .pdf
...
UNSUPPORTED_MESSAGE = 'Конверсия этого формата не поддерживается 😇 /help - поддерживаемые форматы'
